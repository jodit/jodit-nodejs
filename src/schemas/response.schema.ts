...
export const FileItemSchema = z.object({
  ...
  changed: z.string().optional()
    ...
    .openapi({ description: 'Last modified date (ISO)', example: '2025-01-01T00:00:00.000Z' }),
...
export const SourceDataSchema = z.object({
  ...
  baseurl: z.string()
    ...
    .openapi({ description: 'Base URL for files', example: 'http://localhost:3000/files/test/' }),
  path: z.string()
...
export const FilesSuccessResponseSchema = z.object({
  ...
  data: z.object({
    ...
    sources: z.array(SourceDataSchema)
...
export const ErrorResponseSchema = z.object({
  ...
  data: z.object({
    ...
    messages: z.array(z.string())
      ...
      .openapi({ description: 'Error messages', example: ['Validation failed'] })
  }).describe('Error data')
