...
describe('Image Resize (GET /?action=imageResize)', () => {
  ...
  describe('Access Control', () => {
    ...
    it('should deny access when role does not have IMAGE_RESIZE permission', async () => {
      aclTestServer = await startTestServer({
        sources: {
          test: {
            name: 'test',
    ...
    it('should allow access when role has IMAGE_RESIZE permission', async () => {
      aclTestServer = await startTestServer({
        sources: {
          test: {
            name: 'test',
    ...
    it('should check path-based permissions for IMAGE_RESIZE action', async () => {
      aclTestServer = await startTestServer({
        sources: {
          test: {
            name: 'test',
    ...
    it('should use wildcard role to deny IMAGE_RESIZE access to all roles', async () => {
      aclTestServer = await startTestServer({
        sources: {
          test: {
            name: 'test',
